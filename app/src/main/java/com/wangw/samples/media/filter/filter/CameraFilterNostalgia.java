...
public class CameraFilterNostalgia extends CameraFilter {

    protected int mNostalgiaTextureId_1;
    protected int mNostalgiaTextureId_2;
    ...
    public CameraFilterNostalgia(Context context) {
        super(context);
        mNostalgiaTextureId_1 = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
        initByteBuffer_1();
        mNostalgiaTextureId_2 = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
        initByteBuffer_2();
    }

    public CameraFilterNostalgia(Context context, boolean isForCamera) {
    ...
    protected int createProgram(Context applicationContext) {
        return GlUtil.createProgram(applicationContext, R.raw.vertex_shader_default,
                R.raw.fragment_shader_ext_nostalgia, mIsForCamera);
    }

    private void initByteBuffer_1() {
    ...
    protected void getGLSLValues() {
        ...
        mToneCurveTextureUniformLocation2 = GLES20.glGetUniformLocation(mProgramHandle, "curve2");
        ...
        mBlurSizeUniformLocation = GLES20.glGetUniformLocation(mProgramHandle, "blurSize");
    ...
    protected void bindTexture(int textureId) {
        ...
        if (mNostalgiaTextureId_1 != -1) {
            GLES20.glActiveTexture(GLES20.GL_TEXTURE3);
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mNostalgiaTextureId_1);
            GLES20.glUniform1i(mToneCurveTextureUniformLocation, 3);
        }
        if (mNostalgiaTextureId_2 != -1) {
            GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mNostalgiaTextureId_2);
    ...
    protected void bindGLSLValues(float[] mvpMatrix, FloatBuffer vertexBuffer, int coordsPerVertex,
        ...
        if (mIncomingWidth != 0 && mIncomingHeight != 0) {
            ...
            GLES20.glUniform1f(mTexelHeightUniformLocation, (1.0f / (float) mIncomingHeight));
        }
    }
