...
public class CameraFilterTender extends CameraFilter {
    ...
    public CameraFilterTender(Context context) {
        super(context);
    ...
    public CameraFilterTender(Context context, boolean isForCamera) {
