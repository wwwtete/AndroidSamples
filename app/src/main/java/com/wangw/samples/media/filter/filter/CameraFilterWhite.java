...
public class CameraFilterWhite extends CameraFilter {
    ...
    protected int mWhiteTextureId;
    private int mToneCurveTextureUniformLocation;

    public CameraFilterWhite(Context applicationContext) {
        super(applicationContext);
        mWhiteTextureId = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
        initByteBuffer();
    }

    public CameraFilterWhite(Context applicationContext, boolean isForCamera) {
        super(applicationContext, isForCamera);
        mWhiteTextureId = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
        initByteBuffer();
    }
    ...
    protected void bindTexture(int textureId) {
        ...
        if (mWhiteTextureId != -1){
            GLES20.glActiveTexture(GLES20.GL_TEXTURE3);
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mWhiteTextureId);
