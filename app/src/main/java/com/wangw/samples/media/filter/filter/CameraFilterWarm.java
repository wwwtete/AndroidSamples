...
public class CameraFilterWarm extends CameraFilter {
    ...
    public CameraFilterWarm(Context context) {
        super(context);
        mToneCurveTexture = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
        initBuffer();
        mMaskGrey1TextureId = GlUtil.loadTexture(context, "filter/mask_1.jpg");
        mMaskGrey2TextureId = GlUtil.loadTexture(context, "filter/mask_2.jpg");
    }

    public CameraFilterWarm(Context context, boolean isForCamera) {
    ...
    protected void getGLSLValues() {
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(mProgramHandle, "layerImage");
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(mProgramHandle, "greyFrame");
    }
    ...
    protected void bindTexture(int textureId) {
        ...
        if (mToneCurveTexture != -1) {
            ...
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mToneCurveTexture);
