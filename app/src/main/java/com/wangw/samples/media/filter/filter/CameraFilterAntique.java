...
public class CameraFilterAntique extends CameraFilter {

    protected int mAntiqueTextureId;
    private int mToneCurveTextureUniformLocation;

    public CameraFilterAntique(Context context) {
        super(context);
        mAntiqueTextureId = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
        initByteBuffer();
    }

    public CameraFilterAntique(Context context, boolean isForCamera) {
    ...
    protected int createProgram(Context applicationContext) {
        return GlUtil.createProgram(applicationContext, R.raw.vertex_shader_default,
                R.raw.fragment_shader_ext_antique, mIsForCamera);
    }
    ...
    protected void bindTexture(int textureId) {
        ...
        if(mAntiqueTextureId != -1){
            GLES20.glActiveTexture(GLES20.GL_TEXTURE3);
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mAntiqueTextureId);
