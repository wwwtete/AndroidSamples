...
public class CameraFilterCool extends CameraFilter {

//    protected int maExtraTextureCoordLoc;
    private int mToneCurveTextureUniformLocation;
    protected int mExtraTextureId;

    public CameraFilterCool(Context context) {
        super(context);
        mExtraTextureId = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
//        initBuffer();
    }

    public CameraFilterCool(Context context, boolean isForCamera) {
