...
public class CameraFilterHealthy extends CameraFilter {
    ...
    public CameraFilterHealthy(Context context) {
        super(context);
        mExtraTextureId = GlUtil.createTexture(GLES20.GL_TEXTURE_2D);
        initBuffer();
        mMaskGrey1TextureId = GlUtil.loadTexture(context, "filter/mask_1.jpg");
    }

    public CameraFilterHealthy(Context context, boolean isForCamera) {
    ...
    protected void getGLSLValues() {
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(mProgramHandle, "mask");
    ...
    protected void bindGLSLValues(float[] mvpMatrix, FloatBuffer vertexBuffer, int coordsPerVertex,
        ...
        if(mIncomingWidth != 0 && mIncomingHeight != 0){
            GLES20.glUniform1f(mTexelWidthUniformLocation, 1.0f / mIncomingWidth);
            GLES20.glUniform1f(mTexelHeightUniformLocation, 1.0f / mIncomingHeight);
        }
