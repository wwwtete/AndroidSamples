...
import com.wangw.samples.materialrangebar.colorpicker.ColorPickerDialog;
...
public class DefaultMaterialrangebarActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_default_materialrangebar);
